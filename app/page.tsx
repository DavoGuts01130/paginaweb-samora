...
const heroButtonClass =
  "flex min-h-12 items-center justify-center rounded-full border border-white/30 bg-white/[0.03] px-8 py-3 text-sm font-medium !text-white transition hover:border-white hover:bg-white hover:!text-black";
        ...
        <section className="relative flex min-h-screen overflow-hidden px-4 pt-24 sm:px-6">
          ...
          <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col items-center justify-center py-12 text-center sm:py-16 md:py-20">
            ...
            <div className="mt-9 flex w-full max-w-sm flex-col gap-3 sm:max-w-none sm:flex-row sm:justify-center sm:gap-4">
              <Link href="/portafolio" className={heroButtonClass}>
                Ver portafolio
              </Link>

              <Link href="/servicios#cotizador" className={heroButtonClass}>
                Realizar cotización
              </Link>

              <Link href="/servicios" className={heroButtonClass}>
                Ver servicios
              </Link>
            </div>
